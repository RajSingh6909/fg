...
import com.example.foodgospel.Models.PoultryGrown;

import java.io.Serializable;
import java.util.ArrayList;

@Entity
public class AddPoultryFarmAllData implements Serializable {

    @PrimaryKey
    private int user_id;

    private int farm_type, language, state, district, city,farmer_id;
    private String name = "", poultry_farm_name = "", company_name="", contact_mode = "", landline = "", mobile = "", whatsapp = "", email = "", market_email = "", qualification = "", latitude = "", longitude = "", address = "", mailing_address = "", land_ownership = "", land_hold = "", land_hold_type = "", delivery = "", send_option = "", cold_chain_store = "", delivery_time = "", time_type = "", product_use = "", postal_code = "";

    @Embedded
    public ArrayList<Category> arlPoultryGrown = new ArrayList<>();

    public AddPoultryFarmAllData() {
    }
    ...
    public String getPoultry_farm_name() {
        return poultry_farm_name;
    }

    public void setPoultry_farm_name(String poultry_farm_name) {
        this.poultry_farm_name = poultry_farm_name;
    }
    ...
    public ArrayList<Category> getArlPoultryGrown() {
        return arlPoultryGrown;
    }

    public void setArlPoultryGrown(ArrayList<Category> arlPoultryGrown) {
        this.arlPoultryGrown = arlPoultryGrown;
    }

...
@Entity
public class AddDairyAllData implements Serializable {

    @PrimaryKey
    int user_id;

    int farm_type, language, state, district, city,farmer_id;
    String name = "", farm_name = "", company_name="", contact_mode = "", landline = "", mobile = "", whatsapp = "", email = "", market_email = "", qualification = "", latitude = "", longitude = "", address = "", mailing_address = "", land_ownership = "", land_hold = "", land_hold_type = "", delivery = "", send_option = "", cold_chain_store = "", delivery_time = "", time_type = "", product_use = "", postal_code = "";

    @Embedded
    ArrayList<LiveStockGrown> arlLiveStockGrown = new ArrayList<>();

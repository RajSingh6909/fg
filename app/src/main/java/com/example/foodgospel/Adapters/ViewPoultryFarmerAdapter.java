...
public class ViewPoultryFarmerAdapter extends RecyclerView.Adapter<ViewPoultryFarmerAdapter.ViewPoultryViewHolder> {

    Context context;
    ArrayList<UserFarmer> arlFarmer = new ArrayList<>();

    public ViewPoultryFarmerAdapter(Context context, ArrayList<UserFarmer> arlFarmer) {
    ...
    @NonNull
    @Override
    public ViewPoultryFarmerAdapter.ViewPoultryViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.raw_dairy_farmer, viewGroup, false);
        return new ViewPoultryViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull final ViewPoultryFarmerAdapter.ViewPoultryViewHolder farmerViewHolder, int i) {

        final UserFarmer objFarmer = arlFarmer.get(i);


        if (objFarmer.getFarmType().equalsIgnoreCase("3")) {
            ...
            farmerViewHolder.imgEdit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent i = new Intent(context, PoultryFarmActivity.class);
                    Bundle b = new Bundle();
                    b.putSerializable("PoultryEditData", objUserFarmer);
    ...
    public class ViewPoultryViewHolder extends RecyclerView.ViewHolder {

        TextView txtFarmerName, txtMobile, txtEmail, txtCity, txtComapnyName;
        ImageView imgEdit, imgDelete;

        public ViewPoultryViewHolder(@NonNull View itemView) {
            super(itemView);

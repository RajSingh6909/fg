 ...
 */
public class AddDairyStepThreeFragment extends Fragment implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    RadioButton rbSelectedValue, rbOwned, rbLeased;
    ...
    private String RbSelectedValue = " ";

    public AddDairyStepThreeFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_add_dairy_step_three, container, false);

        activity = (DairyActivity) getActivity();
        ...
        final AddDairyAllData objAddDairyAllData = (AddDairyAllData) getArguments().getSerializable("DairyStepTwo");
        ...
        if (isEditStepTwo) {
            objFarmer = (UserFarmer) getArguments().getSerializable("DairyEditStepTwo");
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (checkAllFields()) {
                    ...
                    objAddDairyAllData.setLand_ownership(RbSelectedValue);
                    objAddDairyAllData.setLand_hold_type(LandHoldType);
                    objAddDairyAllData.setAddress(etAddress.getText().toString());
                    objAddDairyAllData.setPostal_code(etPostalCode.getText().toString());
                    objAddDairyAllData.setMailing_address(etMailingAddress.getText().toString());
                    objAddDairyAllData.setLand_hold(etLandHoldName.getText().toString());
                    objAddDairyAllData.setLatitude(String.valueOf(src.latitude));
                    objAddDairyAllData.setLongitude(String.valueOf(src.longitude));

                    //fragment calling step-4
                    //Fragment calling step - 3
                    FragmentManager fragmentManager = getActivity().getSupportFragmentManager();
                    final FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                    final AddDairyStepFourFragment objAddDairyStepFourFragment = new AddDairyStepFourFragment();
                    Bundle bundle = new Bundle();
                    bundle.putSerializable("DairyStepThree", objAddDairyAllData);
                    bundle.putSerializable("DairyEditStepThree", objFarmer);
                    bundle.putSerializable("isEditThree", isEditStepTwo);
                    objAddDairyStepFourFragment.setArguments(bundle);
                    fragmentTransaction.replace(R.id.frameLayout, objAddDairyStepFourFragment).commit();
